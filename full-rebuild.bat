...
echo FULL_SIGN > C:\Users\Default.L-HCG-9FVVGS3\OneDrive\Desktop\Adblocker\final-status.txt
powershell -ExecutionPolicy Bypass -NoProfile -File C:\Users\Default.L-HCG-9FVVGS3\OneDrive\Desktop\Adblocker\full-sign.ps1 > C:\Users\Default.L-HCG-9FVVGS3\OneDrive\Desktop\Adblocker\sign-log.txt 2>&1
