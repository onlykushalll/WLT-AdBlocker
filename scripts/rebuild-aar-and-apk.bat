...
echo AAR_BUILD_START > C:\Users\Default.L-HCG-9FVVGS3\OneDrive\Desktop\Adblocker\final-status.txt
...
echo Rebuilding APK with new wlt.aar...
...
echo APK_COPIED_TO_DESKTOP >> C:\Users\Default.L-HCG-9FVVGS3\OneDrive\Desktop\Adblocker\final-status.txt
echo %DATE% %TIME% >> C:\Users\Default.L-HCG-9FVVGS3\OneDrive\Desktop\Adblocker\final-status.txt
