...
echo SIGN2 > C:\Users\Default.L-HCG-9FVVGS3\OneDrive\Desktop\Adblocker\final-status.txt
powershell -ExecutionPolicy Bypass -NoProfile -File C:\Users\Default.L-HCG-9FVVGS3\OneDrive\Desktop\Adblocker\sign-currentuser.ps1 > C:\Users\Default.L-HCG-9FVVGS3\OneDrive\Desktop\Adblocker\sign-log.txt 2>&1
echo SIGN2_DONE >> C:\Users\Default.L-HCG-9FVVGS3\OneDrive\Desktop\Adblocker\final-status.txt
