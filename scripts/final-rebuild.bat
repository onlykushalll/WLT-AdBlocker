...
echo STEP1_GOMOBILE > C:\Users\Default.L-HCG-9FVVGS3\OneDrive\Desktop\Adblocker\final-status.txt
...
echo Running gomobile bind (root package only)...
...
echo STEP2_GRADLE >> C:\Users\Default.L-HCG-9FVVGS3\OneDrive\Desktop\Adblocker\final-status.txt
