# Full signing + cert store installation for WDAC bypass
$ErrorActionPreference = 'Stop'

# Find or create the WLT code signing cert
...
# Ensure cert is in Trusted Root and Trusted Publishers (LocalMachine)
